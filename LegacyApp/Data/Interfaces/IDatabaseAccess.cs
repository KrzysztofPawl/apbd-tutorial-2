...
public class ClientDataBaseAccess : IDatabaseAccess<Client>
{
    /// <summary>
    /// This collection is used to simulate remote database
    /// </summary>
    private static readonly Dictionary<int, Client> _clientDataBase = new Dictionary<int, Client>()
    {
    ...
    public Client GetById(int clientId)
    {
        ...
        if (_clientDataBase.TryGetValue(clientId, out var client))
            return client;
